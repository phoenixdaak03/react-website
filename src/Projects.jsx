...
export default function Projects({projectTitle, description, topic, logo, code="", report=""}){
    return(
        ...
        <button className="!bg-transparent !border-none !outline-none !transition delay-150 duration-700 ease-in-out hover:text-white hover:scale-110 h-full hover:animate-pulse"> 
