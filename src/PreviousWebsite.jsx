...
export default function PreviousWebsite() {
  ...
  return (   
      <button className="hover:animate-pulse !bg-transparent !border-none !outline-none !transition delay-150 duration-700 ease-in-out hover:text-white hover:scale-110" onClick={handleClick}>
